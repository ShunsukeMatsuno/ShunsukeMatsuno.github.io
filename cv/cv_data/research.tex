...
\paperentry
	...
	\begin{cvitems}  % Presentations
		\item {Presented at: Hawaii Accounting Research Conference (CA), Columbia University (SM), AES Winter Retreat (CA), AES Annual Conference (SM)}			
	\end{cvitems}
	}
...
\paperentry
	...
	{2024}
	{https://shunsukematsuno.github.io/papers/StackelbergDisclosure.pdf}  % paper link
	{}   % link journal
	{}   % Journal
	{
	\begin{cvitems}  % Presentations
